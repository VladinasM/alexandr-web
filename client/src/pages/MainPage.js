    ...
    <React.Fragment>
      ...
      <section className="home" id="home">
        ...
        <div className="content">
          ...
          <p>Клиника создана коллективом стоматологов высокой квалификации, имеющих огромный опыт практической работы и
            прошедших стажировку в ведущих западных стоматологических клиниках, а также постоянно повышающих свою
            квалификацию, проходя различные обучающие курсы по применению современных технологий.</p>
          {
             user.user.role === 'пациент' &&
            <Link to={SET_APPOINTMENT_ROUTE} className="btn">Записаться на приём</Link>
          }
          <br/>
          {
            (user.user.role === 'доктор' || user.user.role === 'админ') &&
            <Link to={APPOINTMENT_LIST_ROUTE} className="btn">Посмотреть все обращения</Link>
          }
        </div>
      ...
      <section className="about" id="about">
        ...
        <div className="row">
          ...
          <div className="content">
            ...
            <p>Современная стоматологическая клиника, специализирующаяся на передовой диагностике и лечении
              стоматологических заболеваний.</p>
            <p>Мы гарантируем комплексную диагностику и предлагаем различные формы стоматологической помощи,
              хирургические процедуры и косметические стоматологические услуги.</p>
          </div>
